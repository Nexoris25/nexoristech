...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'An Insights author or fact-checker, the EEAT Person behind an article (PRD Stage 8).';
    displayName: 'Author';
    pluralName: 'authors';
    singularName: 'author';
  };
...
export interface ApiCaseStudyCaseStudy extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A client project case study with verified metrics (PRD proof, case study hub).';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    industry: Schema.Attribute.Relation<'manyToOne', 'api::category.category'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'An Insights category for grouping articles (PRD Stage 8).';
...
export interface ApiCookiePolicyCookiePolicy extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'The cookie policy, as section and plain-summary pairs (PRD legal pages).';
...
export interface ApiInsightInsight extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'An Insights article with the EEAT structure: author and fact-checker, TL;DR, FAQ, and SEO controls (PRD Stage 8).';
    displayName: 'Insight';
    pluralName: 'insights';
  ...
  attributes: {
    ...
    factChecker: Schema.Attribute.Relation<'manyToOne', 'api::author.author'>;
...
export interface ApiJobJob extends Struct.CollectionTypeSchema {
  collectionName: 'jobs';
  info: {
    description: 'A careers posting, rendered with JobPosting schema (PRD Stage 8).';
    displayName: 'Job';
    pluralName: 'jobs';
    singularName: 'job';
  };
  ...
  attributes: {
    applyEmail: Schema.Attribute.Email;
...
export interface ApiPrivacyPolicyPrivacyPolicy extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'The privacy policy, as section and plain-summary pairs (PRD legal pages).';
...
export interface ApiPseoPagePseoPage extends Struct.CollectionTypeSchema {
  collectionName: 'pseo_pages';
  info: {
    description: 'A programmatic SEO permutation page (PRD 9.4 to 9.7). Unpublished by default; the publish guard enforces the non-negotiable quality and data-readiness gate before it can go live.';
    displayName: 'Programmatic Page';
    pluralName: 'pseo-pages';
    singularName: 'pseo-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dataSources: Schema.Attribute.Component<'shared.source', true>;
    factChecker: Schema.Attribute.Relation<'manyToOne', 'api::author.author'>;
    faq: Schema.Attribute.Component<'shared.faq-item', true>;
    featureMatrix: Schema.Attribute.Component<'shared.metric', true>;
    h1: Schema.Attribute.String & Schema.Attribute.Required;
    hasProprietaryInsight: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    industryLabel: Schema.Attribute.String;
    intent: Schema.Attribute.Enumeration<['capability', 'cost', 'comparison']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'capability'>;
    localDataPoints: Schema.Attribute.Component<'shared.source', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    location: Schema.Attribute.String;
    painPoints: Schema.Attribute.RichText;
...
export interface ApiRedirectRedirect extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A managed 301 or 302 redirect (PRD Stage 7). Validated against loops and chains; served by the website.';
...
export interface ApiTermsOfServiceTermsOfService
  ...
  collectionName: 'terms_of_service';
  info: {
    description: 'The terms of service, as section and plain-summary pairs (PRD legal pages).';
...
export interface ApiTestimonialTestimonial extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A client testimonial for the proof bands and carousel (PRD proof, verified only).';
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::pseo-page.pseo-page': ApiPseoPagePseoPage;
