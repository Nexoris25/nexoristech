 ...
 * numbers or names, English only, plain words, no em dash, name and link the source page. The
 * context block is the only variable part.
 */
...
/** Format the retrieved chunks as the context block, each with its page title and URL for citation. */
