    ...
    steps: [
      {
        ...
        body: "We establish the strategic and technical foundation for long-term search visibility: understanding your business, audience, competitors, and current performance, and identifying the highest-impact opportunities for growth.",
      },
      {
        title: "Strategy & Planning",
        body: "Using the discovery insights, we develop a structured roadmap that aligns your content, website, and optimisation efforts with your business objectives and your customer journey.",
      },
      {
        title: "Content Creation & Optimisation",
        body: "We execute the strategy by creating and optimising content while continuously improving your on-page experience, technical performance, and AI search visibility.",
      },
      {
        title: "Performance Monitoring & Improvement",
        body: "We monitor performance, measure outcomes, and refine the strategy using real-world data to drive continuous gains in visibility, traffic, engagement, and conversions.",
      },
    ],
    note: (
      <>
