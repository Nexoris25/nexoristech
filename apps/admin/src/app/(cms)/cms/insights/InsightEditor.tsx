        ...
        <div className="flex min-w-0 flex-col gap-5">
          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-4 shadow-subtle sm:p-5">
            ...
            <label className="mt-4 flex flex-col gap-1.5">
              <span className="flex items-center justify-between"><span className={label}>Excerpt</span><span className="text-[0.72rem] text-slate-500">{excerpt.length}/{EXCERPT_MAX}</span></span>
              <textarea name="excerpt" value={excerpt} maxLength={EXCERPT_MAX} onChange={(e) => setExcerpt(e.target.value)} rows={2} placeholder="A short summary used in cards and search results..." className={field} />
            </label>
          </section>
