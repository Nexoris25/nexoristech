...
const base =
  "inline-flex items-center justify-center gap-2 rounded-card font-roboto font-600 cursor-pointer transition-colors disabled:cursor-not-allowed disabled:opacity-60 min-h-[44px]";
